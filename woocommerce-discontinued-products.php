...
add_action( 'init', 'woocommerce_discontinued_product_init' );
add_action( 'woocommerce_product_options_general_product_data', 'woocommerce_discontinued_product_add_custom_fields' );
add_action( 'woocommerce_process_product_meta', 'woocommerce_discontinued_product_save_custom_fields' );
 ...
 * @return void
 */
function woocommerce_discontinued_product_init()
{
    register_post_status( 'wc-discontinued', array(
        'label' => __( 'Discontinued', 'woocommerce_discontinued_product' ),
        'public' => true,
 ...
 * @return void
 */
function woocommerce_discontinued_product_add_custom_fields()
{
    ...
    woocommerce_wp_checkbox(array(
        ...
        'label' => __( 'Discontinued', 'woocommerce_discontinued_product' ),
        'name' => '_discontinued',
        'description' => __( 'Check this box to mark this product as discontinued.', 'woocommerce_discontinued_product' )
    ));
    echo '</div>';
}
 ...
 * @return void
 */
function woocommerce_discontinued_product_save_custom_fields( $post_id )
{
